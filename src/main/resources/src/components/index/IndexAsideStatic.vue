<template>
  <el-aside class="index-aside" height="100vh" width="200px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" :v-if="role==item.roleName" class="menulist-item" style="margin-top: 50px; height:100%; background-color:#FFFFFF">
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#FFFFFF" text-color="#000000" active-text-color="#7571F9" default-active="0">
          <el-menu-item index="0" :style="menulistBorderBottom" @click="backDiagnose('')"><i v-if="false" class="el-icon-s-home" />首页</el-menu-item>
...
export default {
  ...
  mounted() {
    ...
    console.log("MenuList: " + this.menuList[0].roleName);
...
<style lang="scss" scoped>
  ...
  @media (max-width: 768px) {
    ...
    .el-menu-item, .el-submenu__title {
      padding: 10px 20px; /* 减少内边距，增加点击区域 */
    }
  }
